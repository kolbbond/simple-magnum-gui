// test run our current sharing function
// 240416 -

// @hey, figure out which headers we can include through "guild"
// #include <array>
#include <future>
#include <iostream>
...
#include "guild/GuiMain.hh"
#include "guild/ImGuiWrapper.hh"
#include "guild/ImPlotWrapper.hh"
...
int main(int argc, char *argv[]) {
  ...
  // second window
  /*
  ShWindowWrapperPr window2 = WindowWrapper::create();
  window2->set_name(std::string("window 2"));
  window2->init();
  */
